...
\begin{figure}[t]
    \centering
    \subfloat[Q1]{
     	\includegraphics[scale=0.22, page=1]{2.gcsm/fig/6.QueryVis-crop.pdf}
    }\hfil
     \subfloat[Q2]{
		\includegraphics[scale=0.22, page=3]{2.gcsm/fig/6.QueryVis-crop.pdf}
    }\hfil
    \subfloat[Q3]{
		\includegraphics[scale=0.22, page=4]{2.gcsm/fig/6.QueryVis-crop.pdf}
    }\\ \vspace{-.5em}
    \subfloat[Q4]{
		\includegraphics[scale=0.22, page=6]{2.gcsm/fig/6.QueryVis-crop.pdf}
    }\hfil
    \subfloat[Q5]{
     	\includegraphics[scale=0.32, page=7]{2.gcsm/fig/6.QueryVis-crop.pdf}
    }\hfil
    \subfloat[Q6]{
     	\includegraphics[scale=0.32, page=8]{2.gcsm/fig/6.QueryVis-crop.pdf}
    }
    %\vspace{-1em}
...
\begin{figure}[t]
   ...
   \subfloat[Q1]{ 
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/FR4096-1-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q2]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/FR4096-2-crop.pdf}
    } \hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/FR4096-3-crop.pdf}
    }\\  \vspace{-.5em}
    \captionsetup[subfigure]{oneside,margin={0.4cm,0cm}}
    \subfloat[Q4]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/FR4096-4-crop.pdf}
    } \hfil
     \captionsetup[subfigure]{oneside,margin={0.2cm,0cm}}
    \subfloat[Q5]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/FR4096-5-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.2cm,0cm}}
    \subfloat[Q6]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/FR4096-6-crop.pdf}
    }
...
\begin{figure}[t]
   \centering
    \captionsetup[subfigure]{oneside,margin={0.4cm,0cm}}
   \subfloat[Q1]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3K4096-1-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q2]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3K4096-2-crop.pdf}
    } \hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3K4096-3-crop.pdf}
    }\\ \vspace{-.5em}
     \captionsetup[subfigure]{oneside,margin={0.4cm,0cm}}
    \subfloat[Q4]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3K4096-4-crop.pdf}
    } \hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q5]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3K4096-5-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q6]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3K4096-6-crop.pdf}
    }
...
\begin{figure}[t]
   ...
   \captionsetup[subfigure]{oneside,margin={0.4cm,0cm}}
   \subfloat[Q1]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10K8192-1-crop.pdf}
    }\hfil
    \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q2]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10K8192-2-crop.pdf}
    } \hfil
    \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10K8192-3-crop.pdf}
    }\\  \vspace{-.5em}
    \captionsetup[subfigure]{oneside,margin={0.4cm,0cm}}
    \subfloat[Q4]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10K8192-4-crop.pdf}
    } \hfil
    \captionsetup[subfigure]{oneside,margin={0.1cm,0cm}}
    \subfloat[Q5]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10K8192-5-crop.pdf}
    }\hfil
    \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[Q6]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10K8192-6-crop.pdf}
    }
...
\vspace{-1em}
   \centering
   \subfloat[PA-MC3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/mc-1-crop.pdf}
    }\hfil
    \subfloat[PA-MC4]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/mc-2-crop.pdf}
    } \hfil
    \subfloat[PA-MC5]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/mc-3-crop.pdf}
    }\\  \vspace{-.5em}
    \subfloat[CA-MC3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/mc-4-crop.pdf}
    } \hfil
    \subfloat[CA-MC4]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/mc-5-crop.pdf}
    }\hfil
    \subfloat[CA-MC5]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/mc-6-crop.pdf}
    }
...
\begin{figure}[t]
   ...
   % \captionsetup[subfigure]{oneside,margin={0.4cm,0cm}}
   \subfloat[SF3K-Q6]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/3KQ6-crop.pdf}
    } %\hfil \\
    % \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[SF10K-Q5]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/10KQ5-crop.pdf}
    } \hfil
...
\begin{figure}
    ...
    \subfloat[SF3K-Q1]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/vsgm-3k-q1-crop.pdf}
        \label{fig:vsgm_3kq1}
    }\hfil
    \subfloat[SF3K-Q2]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/vsgm-3k-q2-crop.pdf}
        \label{fig:vsgm_3kq2}
    }\hfil
    \subfloat[SF3K-Q3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/vsgm-3k-q3-crop.pdf}
        \label{fig:vsgm_3kq3}
    } \\
     \vspace{-0.5em}
    \subfloat[SF10K-Q1]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/vsgm-10k-q1-crop.pdf}
        \label{fig:vsgm_10kq1}
    }\hfil
    \subfloat[SF10K-Q2]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/vsgm-10k-q2-crop.pdf}
        \label{fig:10kq2}
    }\hfil
    \subfloat[SF10K-Q3]{
        \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/vsgm-10k-q3-crop.pdf}
        \label{fig:10kq3}
    }
...
\begin{figure}[t]
    ...
    \subfloat[LJ-Q1]{
     	\includegraphics[scale=0.5, page=1]{2.gcsm/expfig/rp-lj-q1-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[LJ-Q2]{
     	\includegraphics[scale=0.5, page=1]{2.gcsm/expfig/rp-lj-q2-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.3cm,0cm}}
    \subfloat[LJ-Q3]{
     	\includegraphics[scale=0.5, page=1]{2.gcsm/expfig/rp-lj-q3-crop.pdf}
    }\\
     \vspace{-0.5em}
      \captionsetup[subfigure]{oneside,margin={0.2cm,0cm}}
    \subfloat[AZ-Q4]{
     	\includegraphics[scale=0.5, page=1]{2.gcsm/expfig/rp-amazon-q4-crop.pdf}
    }\hfil
     \captionsetup[subfigure]{oneside,margin={0.0cm,0cm}}
    \subfloat[AZ-Q5]{
     	\includegraphics[scale=0.5, page=1]{2.gcsm/expfig/rp-amazon-q5-crop.pdf}
    }\hfil
    \subfloat[AZ-Q6]{
     	\includegraphics[scale=0.5, page=1]{2.gcsm/expfig/rp-amazon-q6-crop.pdf}
    } 
...
\begin{figure}[t]
    ...
    \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/percentage-crop.pdf}
    \label{fig:dist}
    }\hfil
    \captionsetup[subfigure]{oneside,margin={0.7cm,0cm}}
    \subfloat[Cache Coverage]{
    \includegraphics[scale=0.5, page=1]{2.gcsm/expfig/coverage-crop.pdf}
    \label{fig:coverage}
    }
