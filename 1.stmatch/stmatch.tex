...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.58]{1.stmatch/figure/loop_example_orig.pdf}
...
\begin{wrapfigure}{r}{0.12\textwidth}
     \centering
      %   \vspace{-.5em}
    \includegraphics[scale=0.56]{1.stmatch/figure/example_query.pdf}
    \vspace{-.5em}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.55]{1.stmatch/figure/while_loop_orig.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.52]{1.stmatch/figure/getcandidates.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.53]{1.stmatch/figure/stealing_example.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.53]{1.stmatch/figure/global_steal.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.55]{1.stmatch/figure/while_loop_unrolled.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.53]{1.stmatch/figure/combined_set_operation.pdf}
...
\begin{figure}
    ...
    \includegraphics[scale=0.53]{1.stmatch/figure/dependence_graph.pdf}
    \label{fig:dependence_graph}
    } \hfil
    \subfloat[A compact storage]{
    \includegraphics[scale=0.53]{1.stmatch/figure/dependence_graph_array.pdf}
...
\centering
    ...
    \includegraphics[scale=0.53]{1.stmatch/figure/colored_dependence_graph.pdf}
    \label{fig:colored_dependence_graph}
    }\hfil
     \subfloat[Merged label sets]{
    \includegraphics[scale=0.53]{1.stmatch/figure/improved_colored_dependence_graph.pdf}
...
\begin{figure*}[t]
    \centering
    \subfloat[Enron]{
     \includegraphics[scale=0.53]{1.stmatch/figure/benefit_enron.pdf}
    }\hfil
     \subfloat[MiCo]{
     \includegraphics[scale=0.53]{1.stmatch/figure/benefit_mico.pdf}
    }\\
     \subfloat[YouTube]{
     \includegraphics[scale=0.53]{1.stmatch/figure/benefit_youtube.pdf}
    }\hfil
     \subfloat[LiveJournal]{
     \includegraphics[scale=0.53]{1.stmatch/figure/benefit_livejournal.pdf}
    }
...
\begin{figure}
    \centering
    \includegraphics[scale=.53]{1.stmatch/figure/utilization.pdf}
